...
function About() {
  return (
    <section className="relative md:my-24 pt-12 pb-6 md:px-8 overflow-hidden bg-gradient-to-b from-gray-900 via-zinc-900 to-black text-gray-100 backdrop-blur-3xl shadow-2xl">
