        ...
        <div className="md:max-w-[70%] mx-auto grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-6 place-items-center">
          {[
            ...
            <motion.div
              ...
              viewport={{ once: false, amount: 0.3 }}
              custom={i + 3}
              className="w-full group px-2 py-4  rounded-lg border border-zinc-800/75 bg-zinc-900/40 hover:bg-zinc-900/60 transition-all duration-300 h-40 flex flex-col justify-start items-start"
            >
